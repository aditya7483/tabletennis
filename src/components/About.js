...
export default function About() {
  return (
    <div className='my-3 mb-5' id='about'>
      ...
      <div id='about-box' className='container d-flex flex-lg-row p-0 mb-5 border'>
      ...
      <div className='d-flex container-fluid justify-content-lg-around align-items-center'>
        <div className='row'>
